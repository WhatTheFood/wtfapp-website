...
The application will look for mongodb host, server host and server port in your environment by default. If it doesn't find anything, default are `localhost` as host and `5000` as port.

You can change them this way:

```
export MONGOLAB_URI='localhost'
